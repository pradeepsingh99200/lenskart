    ...
    with mp_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
        ...
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                if ratio > 5.5:
                    CEF_COUNTER += 1
                    cv.putText(frame, 'Blink', (50, 100), FONTS, 1.7, (0, 255, 255), 2)
                else:
                    if CEF_COUNTER > CLOSED_EYES_FRAME:
                        TOTAL_BLINKS += 1
                        CEF_COUNTER = 0

                cv.putText(frame, f'Total Blinks: {TOTAL_BLINKS}', (50, 50), FONTS, 0.7, (255, 0, 0), 2)
            ...
            # Display FPS
            cv.putText(frame, f'FPS: {round(fps, 1)}', (50, 150), FONTS, 1.0, (255, 255, 255), 2)
